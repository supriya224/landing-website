...
const HomePage = () => {
  return (
    <MainLayout>
        <section className='bg-purple-300 sm:bg-cyan-600 md:bg-red-500 lg:bg-indigo-500 xl:text-teal-600 h-auto'>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 relative ">
          <div className=" my-32">
            ...
            <div className=" w-[250px] h-[250px] bg-gradient-to-b from-red-500 via-orange-400 to-yellow-200 rounded-full absolute z-0  top-[3%] left-0 translate-x-[10%] md:translate-x-[100%] translate-y-[20%] blur-[70px]">
          ...
          <div className="h-fit relative items-center ">
            ...
            //   className="absolute top-1 left-10 w-[100%] h-[70%] transform z-10"
              className="absolute top-[-10%] lg:top-[-5%]"
            />
            <Image
              src={IMG}
              alt=""
            //   className="absolute top-56 left-56 w-[80%] h-fit transform rotate-0 z-10"
              className=" absolute top-28 left-24 md:w-[40%] md:top-72 md:left-72 lg:top-44 lg:left-44 xl:top-48 xl:left-48 w-[80%] "
            />
            ...
            //   className="absolute top-40 left-40 w-[80%] h-fit transform rotate-0 z-20"
              className=" absolute top-20 left-16 md:w-[40%] md:top-32 md:left-32 lg:top-32 lg:left-32 xl:top-36 xl:left-36 w-[80%] "
            />
            <Image
              src={IMG1}
              alt=""
            //    className="absolute top-3 w-[80%] h-fit transform rotate-[-120] z-30"
              className="absolute top-0  left-0 lg:top-0  md:top-56 md:left-96 lg:left-0 xl:top-0 xl:left-0  w-[80%] "
            />
          </div>
        </div>
