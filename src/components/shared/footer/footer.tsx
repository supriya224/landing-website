...
const Footer = () => {
  return (
    <footer className="">
      ...
      {/* <div className=" w-[250px] h-[250px]  bg-gradient-to-b from-red-500 via-orange-500 to-yellow-200 rounded-full absolute z-1 top-[50%] left-[50%] translate-x-[50%] translate-y-[50%] blur-[70px]">
      </div> */}
    </footer>
  );
};
